...
export const HeroSection = () => {
  ...
  return (
    <section id="morph" className="w-full h-full flex flex-col gap-8" suppressHydrationWarning>
      <div>
        <Image
          alt="Morph logo"
          src={mounted && theme === "dark" ? "/dark_logo.png" : "/logo.png"}
          width={40}
          height={40}
        />
      ...
      <div className="mx-auto max-w-lg w-full relative">
        ...
        <span className="flex absolute gap-2 items-center -bottom-9 left-[10%] lg:left-1/3 text-foreground/50">
          <span className="text-sm">
            <span className="lg:hidden">Click here</span>
            <span className="hidden lg:inline">Hover here</span> in this area
          </span>
